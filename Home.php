...
<head>
    ...
    <link rel="stylesheet" href="../IT197_BSC_WD_24_45_15/css/home.css">
...
<body>
    ...
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
      ...
      <img  src="../IT197_BSC_WD_24_45_15/Images/Modern Green Health Care Medical Center Logo.jpg"  width="80px"  height="80px" >
...
<div id="carouselExample" class="carousel slide">
 <div class="carousel-inner">
   <div class="carousel-item active">
     <img src="../IT197_BSC_WD_24_45_15/Images/doctor1.jpg.jpg" class="d-block w-100" alt="...">
   </div>
   
   <div class="carousel-item">
     <img src="../IT197_BSC_WD_24_45_15/Images/doctors.jpg.jpg" class="d-block w-100" alt="...">
</div>
...
<div class="p-5 mb-4 bg-body-tertiary rounded-3">
 <div class="container-fluid py-5">
   ...
   <div class="row g-0">
    ...
    <P>We are  the  best healthcare center  in the  country that get<mark> BEST HEALTHCARE AWARDS </mark>one after another in last  10 years.As well as  we have  the  branches in the  countrywide.So we  provide quality services for the customers.<br><h2>These are some of services that you can get from us.</h2></p>
                    <div class="col-lg-4 bg-white border-radius-start-10 wow fadeIn" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeIn;">
                        <div class="p-2-3 bg-light h-100 border-radius-start-10">
                            <span class="mb-4 d-inline-block"><img src="../IT197_BSC_WD_24_45_15/Images/Ndoctor.jpg" alt="..."></span>
                    ...
                    <div class="col-lg-4 bg-white wow fadeIn" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeIn;">
                        <div class="p-2-3 bg-primary h-100">
                            <span class="mb-4 d-inline-block"><img src="../IT197_BSC_WD_24_45_15/Images/hooter.png" alt="..."  height="150px" width="100px"></span>
                    ...
                    <div class="col-lg-4 bg-white border-radius-end-10 wow fadeIn" data-wow-delay="600ms" style="visibility: visible; animation-delay: 600ms; animation-name: fadeIn;">
                        <div class="p-2-3 bg-secondary h-100 border-radius-end-10">
                            <span class="mb-4 d-inline-block"><img src="../IT197_BSC_WD_24_45_15/Images/laboret.png" alt="..."></span>
